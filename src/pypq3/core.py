...
class PQ3Session:
    ...
    def __init__(self, local_device_id: str, remote_device_id: str,
                 shared_secret: SharedSecret, is_initiator: bool = True):
...
class PQ3Protocol:
    ...
    def __init__(self, device_id: str):
        ...
        self.pending_key_exchanges: Dict[str, Tuple[InitialKeyExchange, SharedSecret]] = {}
    ...
    def handle_key_exchange(self, key_exchange_data: str) -> Optional[str]:
        ...
        try:
            # Parse key exchange
            key_exchange = InitialKeyExchange.from_dict(
                json.loads(key_exchange_data)
            )
