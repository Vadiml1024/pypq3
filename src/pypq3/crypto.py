...
class KeyPair:
    ...
    def __init__(
        self,
        ecc_private_key: ec.EllipticCurvePrivateKey,
...
class PQ3Crypto:
    ...
    @staticmethod
    def perform_key_exchange_initiator(
        local_keypair: KeyPair,
        remote_ecc_public: bytes,
        remote_kyber_public: bytes,
    ...
    @staticmethod
    def perform_key_exchange_responder(
        local_keypair: KeyPair, remote_ecc_public: bytes, kyber_ciphertext: bytes
    ) -> SharedSecret:
    ...
    @staticmethod
    def derive_message_key(shared_secret: SharedSecret, context: bytes = b"") -> bytes:
    ...
    @staticmethod
    def encrypt_message(
        key: bytes, plaintext: bytes, additional_data: Optional[bytes] = None
    ) -> bytes:
    ...
    @staticmethod
    def decrypt_message(
        key: bytes, encrypted_data: bytes, additional_data: Optional[bytes] = None
    ) -> bytes:
